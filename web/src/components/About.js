...
const { aboutSection, informationSlice, aboutWrapper } = classes;

const About = (props) => {
  const tailwindClasses = ['p-6',];

  return (
    <section className={`${aboutSection} w-full`}>
      <div className={`${aboutWrapper} container mx-auto`}>
        <div className={[informationSlice, ' ', 'mt-6'].join("")}>
          <h3>About Us</h3>
          <p>
            Established in 2015, FASTER is the only multi-stakeholder national 501(c)(3) non-partisan non-profit organization dedicated to 
            advancing excellence, equality, and justice primarily serving the FilipinX American community in the U.S. tech ecosystem.
          </p>
        </div>
        <div className={informationSlice}>
          ...
          <p>
            ...
            various components in education, professional development, and innovation. Our membership reaches New York, Los Angeles, Chicago, San Diego, Florida, Boston, Seattle and growing. 
            FASTER continues its work through our FASTER Components.
          </p>
        </div>
        <div className={informationSlice}>
          <h3>Our Mission</h3>
          <p>
            We are create, connect, cultivate a multigenerational movement of Filipinx Americans in the 
            Science Technology Engineering Arts and Mathematics working in the science and technology ecosystem 
        ...
        <div className={informationSlice}>
          ...
          <p>
            ...
            Filipinx American Undergraduate Krew - FUNKTion and in partnership with Tech-In-Color K-12 outreach 
            to students of color program founded by FASTER National Board Secretary, Charity Nicolas, 
            and Kollective Hustle Program under ABS-CBN, professional development (FASTER PROS) component 
            for independent and tech company Employee Resource Group (ERG) leaders and members), 
            and innovation component, (FASTER FRESH) for high tech startup entrepreneurs and investing 
            and community building within the industry, we seek to attract, advance, and excel the network 
            of Filipino Americans talent in tech companies.
          </p>
          <p>
            FASTER-Silicon Valley is the founding chapter of FASTER and includes areas located in the San Francisco 
            Bay Area inclusive of all parts of the Bay, SF, East Bay, South Bay, and Peninsula. 
            On terminology for the naming of FASTER. (see Notes below)
          </p>
        </div>
        <div className={informationSlice}>
        ...
        <div className={informationSlice}>
          <h3>Organize</h3>
          <p>
            We seek to empower our community by making information on Filipinx Americans in tech more 
            accessible with a community platform of Filipinx Americans in various professions in tech.
          </p>
        </div>
        <div className={informationSlice}>
          <h3>Give and Invest</h3>
          <p>
            Silicon Valley’s rich history of Asian American contributions is significant. 
            FASTER helps illuminate the stories of the Filipinx American community and their contributions 
            to technology. Through investing in each other, both nurturing early stage startups and 
            donating back to our local communities impacting in tech, we seek to strengthen our 
            Filipinx American community as a whole.
          </p>
          <p>
        ...
        <div className={informationSlice}>
          ...
          <p>
            ...
            (the acronym above). <strong>STEAM - includes “A” acronym, to represents the arts often left out of STEM.</strong>
          </p>
        </div>
        <div className={informationSlice}>
          <h3>Our Team</h3>
